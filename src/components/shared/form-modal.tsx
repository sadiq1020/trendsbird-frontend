...
export function FormModal({
  ...
  if (variant === "sheet") {
    return (
      <Sheet open={open} onOpenChange={onOpenChange}>
        <SheetContent side="right" className="bg-slate-900 border-slate-800 text-slate-100 sm:max-w-lg w-full overflow-y-auto">
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-slate-900 border-slate-800 text-slate-100 sm:max-w-lg w-full max-h-[90vh] overflow-y-auto">
